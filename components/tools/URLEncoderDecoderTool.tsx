...
export function URLEncoderDecoderTool() {
  ...
  const [input, setInput] = useState("https://example.com/?q=teeny tiny web");
  ...
  return (
    <ToolShell
      ...
      description="Convert URL components to safe encoded strings or decode encoded values back into readable text."
    >
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <ToolPanel title={mode === "encode" ? "Raw URL value" : "Encoded URL value"}>
          <textarea
            value={input}
